(function () {
  ...
  const en = {
    ...
    "18 piezas mínimas por cada marca incluida.": "18-piece minimum for each included brand.",
    ...
    "Explora cada catálogo de forma independiente y reúne las referencias elegidas en un único pedido profesional. Cada marca incluida debe alcanzar un mínimo de 18 piezas.": "Explore each catalog independently and gather your chosen references into one professional order. Every included brand must reach a minimum of 18 pieces.",
    "Explora": "Explore",
    ...
    "Alcanza 18 piezas dentro de cada marca que quieras incluir.": "Reach 18 pieces for every brand you wish to include.",
    "Envía": "Send",
    ...
    "Innova Boutique no realiza ventas al público. Selecciona modelos y cantidades hasta completar un mínimo de 18 piezas en cada marca incluida.": "Innova Boutique does not sell to the public. Select models and quantities until you reach a minimum of 18 pieces for each included brand.",
    ...
    "18 piezas mínimas por marca.": "18-piece minimum per brand.",
  ...
  const fr = {
    ...
    "18 piezas mínimas por cada marca incluida.": "Minimum de 18 pièces pour chaque marque incluse.",
    ...
    "Explora cada catálogo de forma independiente y reúne las referencias elegidas en un único pedido profesional. Cada marca incluida debe alcanzar un mínimo de 18 piezas.": "Explorez chaque catalogue séparément et réunissez les références choisies dans une seule commande professionnelle. Chaque marque incluse doit atteindre un minimum de 18 pièces.",
    "Explora": "Explorez",
    ...
    "Alcanza 18 piezas dentro de cada marca que quieras incluir.": "Atteignez 18 pièces pour chaque marque que vous souhaitez inclure.",
    "Envía": "Envoyez",
    ...
    "Innova Boutique no realiza ventas al público. Selecciona modelos y cantidades hasta completar un mínimo de 18 piezas en cada marca incluida.": "Innova Boutique ne vend pas au public. Sélectionnez les modèles et les quantités jusqu’à atteindre un minimum de 18 pièces pour chaque marque incluse.",
    ...
    "18 piezas mínimas por marca.": "Minimum de 18 pièces par marque.",
  ...
  function translateCore(source, target = locale) {
    ...
    const replacements = target === "en"
      ? [
          ...
          [/^Completa 18 piezas en (.+)\.$/, "Reach 18 pieces for $1."],
          [/^Revisa: (.+)\.$/, "Review: $1."],
      ...
      : [
          ...
          [/^Completa 18 piezas en (.+)\.$/, "Atteignez 18 pièces pour $1."],
          [/^Revisa: (.+)\.$/, "Vérifiez : $1."],
